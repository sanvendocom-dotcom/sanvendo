(() => {
  ...
  const SUPPORTED_LANGUAGES = ["vi", "en", "zh", "ko"];
  const LOCALES = {
    vi: "vi-VN",
    en: "en-US",
    zh: "zh-CN",
  ...
  const CATEGORY_LABELS = {
    vi: {
      ...
      "Kỹ thuật": "Sản xuất, Kỹ thuật & QA/QC",
      Logistics: "Kho vận & Chuỗi cung ứng",
      "Chăm sóc khách hàng": "Chăm sóc khách hàng",
      "Lao động phổ thông": "Lao động phổ thông & Vận hành",
      "Bán lẻ & Dịch vụ": "Bán lẻ, Nhà hàng & Dịch vụ",
    },
    en: {
      "Kinh doanh": "Sales & Business Development",
      Marketing: "Marketing & Communications",
      "Kế toán": "Accounting & Finance",
      "Nhân sự": "Administration & Human Resources",
      "Công nghệ": "Information Technology",
      "Kỹ thuật": "Manufacturing, Engineering & QA/QC",
      Logistics: "Logistics & Supply Chain",
      "Chăm sóc khách hàng": "Customer Service",
      "Lao động phổ thông": "General Labor & Operations",
      "Bán lẻ & Dịch vụ": "Retail, Food Service & Hospitality",
    },
    zh: {
      "Kinh doanh": "销售与业务拓展",
      Marketing: "市场营销与传播",
      ...
      "Kỹ thuật": "生产、工程与质量管理",
      Logistics: "物流与供应链",
      "Chăm sóc khách hàng": "客户服务",
      "Lao động phổ thông": "普工与运营",
      "Bán lẻ & Dịch vụ": "零售、餐饮与服务",
    },
    ko: {
      "Kinh doanh": "영업 및 사업개발",
      Marketing: "마케팅 및 커뮤니케이션",
      "Kế toán": "회계 및 재무",
      "Nhân sự": "총무 및 인사",
      "Công nghệ": "정보기술",
      "Kỹ thuật": "생산·엔지니어링·QA/QC",
      Logistics: "물류 및 공급망",
      "Chăm sóc khách hàng": "고객 서비스",
      "Lao động phổ thông": "일반 생산직 및 운영",
  ...
  const TEXT = {
    ...
    ko: {
      ...
      "Bắt đầu ngay": "지금 시작", "Để Sanvendo tìm kiếm nhân sự phù hợp cho doanh nghiệp của bạn.": "Sanvendo가 귀사에 맞는 인재를 찾도록 하세요.", "Đối tác tuyển dụng theo yêu cầu cho doanh nghiệp.": "기업을 위한 맞춤형 채용 파트너.", "Dành cho doanh nghiệp": "기업용", "Dịch vụ tuyển dụng": "채용 서비스", "Nhận báo giá": "견적 받기", "Tìm việc làm": "일자리 찾기", "Quyền lợi ứng viên": "지원자 혜택", "Thông tin": "정보", "Giới thiệu": "소개", "Chính sách bảo mật": "개인정보 처리방침", "Điều khoản sử dụng": "이용약관",
